...
def main():
    ...
    # assemble
    if os.path.exists('%s%s%s%s%s.rom' % (dirname, os.sep, example, os.sep, example)):
        arguments = ['%s%snessemble' % (root, os.sep), '%s%s%s%s%s.asm' % (dirname, os.sep, example, os.sep, example), '--output', '-']
        if flags:
    ...
    # disassemble
    if os.path.exists('%s%s%s%s%s-disassembled.txt' % (dirname, os.sep, example, os.sep, example)):
        arguments = ['%s%snessemble' % (root, os.sep), '%s%s%s%s%s.rom' % (dirname, os.sep, example, os.sep, example), '--disassemble', '--output', '-']
        if flags:
            arguments.extend(flags)
    ...
    # simulate
    if os.path.exists('%s%s%s%s%s-simulated.txt' % (dirname, os.sep, example, os.sep, example)):
        arguments = ['%s%snessemble' % (root, os.sep), '--simulate', '%s%s%s%s%s.rom' % (dirname, os.sep, example, os.sep, example), '--recipe', '%s%s%s%s%s-recipe.txt' % (dirname, os.sep, example, os.sep, example), '--output', '-']
        if flags:
            arguments.extend(flags)
